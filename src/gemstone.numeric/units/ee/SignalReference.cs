...
namespace gemstone.numeric.units.ee
{
    ...
    public struct SignalReference : IEquatable<SignalReference>, IComparable<SignalReference>
    {
        ...
        public override string ToString() => ToString(Acronym, Kind, Index);

        /// <summary>
        /// Returns the hash code for this <see cref="SignalReference"/>.
        /// </summary>
        /// <returns>A 32-bit signed integer hash code.</returns>
        public override int GetHashCode() => ToString(Acronym, Kind, Index).GetHashCode();
        ...
        /// <returns><c>true</c> if the current object is equal to the other parameter; otherwise, <c>false</c>.</returns>
        public bool Equals(SignalReference other) => string.Compare(Acronym, other.Acronym, StringComparison.OrdinalIgnoreCase) == 0 && Kind == other.Kind && Index == other.Index;
        ...
        public static bool operator ==(SignalReference signal1, SignalReference signal2) => signal1.Equals(signal2);
        ...
        /// <param name="signal2">A <see cref="SignalReference"/> right hand operand.</param>
        /// <returns>A boolean representing the result.</returns>
        public static bool operator >(SignalReference signal1, SignalReference signal2) => signal1.CompareTo(signal2) > 0;
        ...
        public static string ToString(string acronym, SignalKind type) => ToString(acronym, type, 0);
        ...
        public static string ToString(string acronym, SignalKind type, int index) => index > 0 ? $"{acronym}-{type.GetAcronym()}{index}" : $"{acronym}-{type.GetAcronym()}";
